/**
 * Face Authentication Debug Page - Refactored Version
 *
 * Now uses the face-scanner domain components
 */
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Camera + face detection + pose data display (using domain components)
          </p>
        </div>
