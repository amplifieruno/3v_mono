...
type Documents = {
    ...
    "\n  query ProfileShowQuery($id: uuid!) {\n    itap_profiles_by_pk(id: $id) {\n      ...itap_profile\n      identities {\n        id\n        images\n        status\n        created_at\n        detections(limit: 50, order_by: { created_at: desc }) {\n          id\n          created_at\n          confidence\n          similarity\n          thumbnail\n          device {\n            id\n            name\n          }\n        }\n      }\n    }\n  }\n": typeof types.ProfileShowQueryDocument,
...
const documents: Documents = {
    ...
    "\n  fragment itap_device on itap_devices {\n    id\n    created_at\n    updated_at\n    name\n    device_type\n    area_id\n    stream_url\n    resolution\n    fps\n    status\n    health_status\n    last_seen\n    configuration\n    recognition_enabled\n    recognition_fps\n    area {\n      id\n      name\n      facility {\n        id\n        name\n      }\n    }\n  }\n": types.Itap_DeviceFragmentDoc,
    "\n  query DeviceListQuery($limit: Int = 10, $offset: Int = 0, $where: itap_devices_bool_exp = {}, $order_by: [itap_devices_order_by!] = {}) {\n    itap_devices(limit: $limit, offset: $offset, order_by: $order_by, where: $where) {\n      ...itap_device\n    }\n    itap_devices_aggregate(order_by: $order_by, where: $where) {\n      aggregate {\n        count\n      }\n    }\n  }\n": types.DeviceListQueryDocument,
    "\n  query DeviceOneQuery($id: uuid!) {\n    itap_devices_by_pk(id: $id) {\n      ...itap_device\n      credentials\n      health_metrics(limit: 20, order_by: { timestamp: desc }) {\n        id\n        timestamp\n        cpu_usage\n        memory_usage\n        disk_usage\n        network_latency\n        frame_rate\n        error_count\n      }\n    }\n  }\n": types.DeviceOneQueryDocument,
    "\n  mutation DeviceInsertOneMutation($object: itap_devices_insert_input!) {\n    insert_itap_devices_one(object: $object) {\n      ...itap_device\n    }\n  }\n": types.DeviceInsertOneMutationDocument,
    "\n  mutation DeviceUpdateOneMutation($id: uuid!, $object: itap_devices_set_input!) {\n    update_itap_devices_by_pk(pk_columns: {id: $id}, _set: $object) {\n      ...itap_device\n    }\n  }\n": types.DeviceUpdateOneMutationDocument,
    "\n  mutation DeviceDeleteOneMutation($id: uuid!) {\n    delete_itap_devices_by_pk(id: $id) {\n      ...itap_device\n    }\n  }\n": types.DeviceDeleteOneMutationDocument,
    "\n  query DeviceDetectionsQuery($device_id: uuid!, $limit: Int = 50) {\n    itap_detections(\n      where: { device_id: { _eq: $device_id } }\n      order_by: { created_at: desc }\n      limit: $limit\n    ) {\n      id\n      created_at\n      confidence\n      similarity\n      is_new_identity\n      bbox\n      thumbnail\n      identity {\n        id\n        status\n        attributes\n        images\n        profile_id\n        profile {\n          id\n          first_name\n          last_name\n        }\n      }\n    }\n    itap_detections_aggregate(where: { device_id: { _eq: $device_id } }) {\n      aggregate {\n        count\n      }\n    }\n  }\n": types.DeviceDetectionsQueryDocument,
